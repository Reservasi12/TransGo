...
<div class="rounded-sm border border-stroke bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
    ...
    <form action="{{ route('admin.transport-services.update', $transportService->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="p-6.5">
            <!-- Row 1: Basic Info -->
            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div class="w-full xl:w-1/2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $transportService->name) }}" placeholder="Enter service name"
                ...
                <div class="w-full xl:w-1/2">
                    ...
                    <input type="text" name="code" value="{{ old('code', $transportService->code) }}" placeholder="e.g. BUS-001"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
            ...
            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div class="w-full xl:w-1/2">
                    ...
                    <div class="relative z-20 bg-transparent dark:bg-slate-700">
                        <select name="type" class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-blue-600 active:border-blue-600 dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500">
                             ...
                             <option value="bus" {{ old('type', $transportService->type) == 'bus' ? 'selected' : '' }}>Bus</option>
                             <option value="shuttle" {{ old('type', $transportService->type) == 'shuttle' ? 'selected' : '' }}>Shuttle</option>
                             <option value="travel" {{ old('type', $transportService->type) == 'travel' ? 'selected' : '' }}>Travel</option>
                        </select>
                    </div>
                ...
                <div class="w-full xl:w-1/2">
                    ...
                    <input type="number" name="capacity" value="{{ old('capacity', $transportService->capacity) }}" placeholder="Number of seats"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
            ...
            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div class="w-full xl:w-1/3">
                    ...
                    <input type="text" name="route_from" value="{{ old('route_from', $transportService->route_from) }}" placeholder="e.g. Jakarta"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
                ...
                <div class="w-full xl:w-1/3">
                    ...
                    <input type="text" name="route_to" value="{{ old('route_to', $transportService->route_to) }}" placeholder="e.g. Bandung"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
                 ...
                 <div class="w-full xl:w-1/3">
                    ...
                    <input type="number" name="price" value="{{ old('price', $transportService->price) }}" placeholder="0"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
            ...
            <!-- Row 4: Schedule -->
             <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                <div class="w-full xl:w-1/2">
                    ...
                    <input type="time" name="departure_time" value="{{ old('departure_time', \Carbon\Carbon::parse($transportService->departure_time)->format('H:i')) }}"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
                ...
                <div class="w-full xl:w-1/2">
                    ...
                    <input type="time" name="arrival_time" value="{{ old('arrival_time', \Carbon\Carbon::parse($transportService->arrival_time)->format('H:i')) }}"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500" required />
            ...
            <div class="mb-4.5">
                ...
                <textarea rows="4" name="description" placeholder="Enter service description"
                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500">{{ old('description', $transportService->description) }}</textarea>
             ...
             <div class="mb-4.5">
                ...
                <textarea rows="2" name="facilities" placeholder="e.g. WiFi, AC, Snack"
                    class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-blue-600 active:border-blue-600 disabled:cursor-default disabled:bg-whiter dark:border-slate-600 dark:bg-slate-700 dark:focus:border-blue-500">{{ old('facilities', $transportService->facilities) }}</textarea>
            ...
            <div class="mb-4.5">
                <label class="mb-2.5 block text-black dark:text-white">
                 ...
                 @if($transportService->image)
                    <div class="mb-3">
                        <img src="{{ asset('storage/' . $transportService->image) }}" alt="Current Image" class="h-32 rounded border border-stroke dark:border-slate-700">
                    </div>
                @endif
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-2">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', $transportService->is_active) ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-blue-600 rounded">
